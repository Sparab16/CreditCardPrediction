...
class Database_Operation:
    ...
    def __init__(self):
        ...
        self.file_object = open('Training_Logs/Database_Operation.txt', 'a+')
    ...
    def dataBaseConnection(self, db_name):
        ...
        Description: This method creates the database with the given name and if database already exists then opens up
                    the connection to that DatabaseTraining
        :param db_name: Name of the database that's to be created
        ...
        try:
            ...
            self.file_object = open('Training_Logs/Database_Operation.txt', 'a+')
            self.logger.log(self.file_object, 'Database {} opened successfully'.format(db_name))
            return conn
        except Exception as e:
            self.file_object = open('Training_Logs/Database_Operation.txt', 'a+')
    ...
    def insertIntoDatabase(self, db_name):
        ...
        try:
            ...
            connection.rollback()
            raise 'database.py.insertIntoDatabase: '+ str(e)
